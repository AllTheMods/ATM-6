onEvent('item.tooltip', e => {
  ...
  addSignedTooltip('mekanism:creative_energy_cube', [
    '§4Will delete energy if not filled!',
    'Check JEI Info tab for more info',
    'on charging the cube'
  ])
  addSignedTooltip('mahoutsukai:caliburn', [
    '§bThis item is obtained by throwing',
    'an enchanted sword into a lake created',
    'by the §3Power Consolidation§b ritual'
  ])
  addSignedTooltip('mahoutsukai:morgan', [
