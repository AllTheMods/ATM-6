onEvent('item.tooltip', e => {
  ...
  formattedTooltip('enderchests:ender_chest', 'Recipe Removed to Convert to EnderStorage')
  formattedTooltip('enderchests:ender_bag', 'Recipe Removed to Convert to EnderStorage')
  formattedTooltip('enderchests:ender_pouch', 'Recipe Removed to Convert to EnderStorage')
  formattedTooltip('endertanks:ender_tank', 'Recipe Removed to Convert to EnderStorage')
  formattedTooltip('endertanks:ender_bucket', 'Recipe Removed to Convert to EnderStorage')
  //#region Pipez
  //pipes
