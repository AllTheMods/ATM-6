onEvent('recipes', e => {
  ...
  shapedRecipe([`witchery_rewitched:belladonna`, `witchery_rewitched:garlic`, `witchery_rewitched:icy_needle`, `witchery_rewitched:water_artichoke_bulb`, `witchery_rewitched:wolfsbane`, `witchery_rewitched:mandrake_root`], `resourcefulbees:beewitched_honeycomb`, 1)
  shapedRecipe([`witchery_rewitched:belladonna`, `witchery_rewitched:garlic`, `witchery_rewitched:icy_needle`, `witchery_rewitched:water_artichoke_bulb`, `witchery_rewitched:wolfsbane`, `witchery_rewitched:mandrake_root`], `resourcefulbees:beewitched_honeycomb_block`, 9)
