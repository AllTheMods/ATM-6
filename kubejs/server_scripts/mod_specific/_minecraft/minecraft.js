onEvent('recipes', e => {
  ...
  colors.forEach(color => {
      ...
      e.shaped(item.of(`minecraft:${color}_carpet`, 3), ['WW'], {
          W: `minecraft:${color}_wool`
      })
      e.shaped(item.of(`minecraft:${color}_stained_glass`, 3), ['GGG', 'G G', 'GGG', ], {
      ...
      e.shaped(`2x minecraft:${color}_wool`, ['C', 'C', 'C', ], {
          C: `minecraft:${color}_carpet`
      })
      e.shaped(item.of(`minecraft:${color}_wool`, 1), ['W', 'W'], {
  ...
  modifyShaped('minecraft:honeycomb_block', 1, ['CCC', 'CCC', 'CCC'], {
