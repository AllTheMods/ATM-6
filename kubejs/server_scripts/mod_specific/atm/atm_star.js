onEvent('recipes', e => {
  ...
  e.shapeless('kubejs:saltpeter_block', ['9x kubejs:saltpeter_ingot']).id('kubejs:saltpeter_block')
  e.shapeless('9x kubejs:saltpeter_ingot', ['kubejs:saltpeter_block']).id('kubejs:saltpeter_ingot')
  e.shapeless('kubejs:saltpeter_ingot', ['9x immersiveengineering:dust_saltpeter']).id('kubejs:saltpeter_ingot')

  e.shapeless('9x kubejs:potassium_nitrate_ingot', ['kubejs:potassium_nitrate_block']).id('kubejs:potassium_nitrate_ingot')
  e.shapeless('kubejs:potassium_nitrate_block', ['9x kubejs:potassium_nitrate_ingot']).id('kubejs:potassium_nitrate_block')
  e.shapeless('kubejs:potassium_nitrate_ingot', ['9x kubejs:potassium_nitrate_dust']).id('kubejs:potassium_nitrate_ingot')

  e.shapeless('9x kubejs:potassium_ingot', ['kubejs:potassium_block']).id('kubejs:potassium_ingot')
  ...
  e.recipes.mekanism.combining('2x kubejs:potassium_nitrate_block', 'kubejs:potassium_block', 'kubejs:saltpeter_block').id('kubejs:potassium_nitrate_block_combine')
  e.recipes.create.mixing('2x kubejs:potassium_nitrate_dust', ['kubejs:potassium_dust', '#forge:dusts/saltpeter']).id('kubejs:potassium_nitrate_dust_mix')
  e.recipes.create.mixing('2x kubejs:potassium_nitrate_ingot', ['kubejs:potassium_ingot', 'kubejs:saltpeter_ingot']).id('kubejs:potassium_nitrate_ingot_mix')
  e.recipes.create.mixing('2x kubejs:potassium_nitrate_block', ['kubejs:potassium_block', 'kubejs:saltpeter_block']).id('kubejs:potassium_nitrate_block_mix')
