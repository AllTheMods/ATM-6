events.listen('recipes', function(e) {
    ...
    mekSaw(item.of('byg:aspen_planks', 6), 'byg:striped_aspen_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('byg:baobab_planks', 6), 'byg:baobab_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('byg:baobab_planks', 6), 'byg:striped_baobab_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('byg:blue_enchanted_planks', 6), 'byg:blue_enchanted_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('byg:blue_enchanted_planks', 6), 'byg:striped_blue_enchanted_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('byg:cherry_planks', 6), 'byg:cherry_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('byg:cherry_planks', 6), 'byg:striped_cherry_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('byg:cika_planks', 6), 'byg:cika_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('byg:cika_planks', 6), 'byg:striped_cika_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('byg:cypress_planks', 6), 'byg:cypress_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('byg:cypress_planks', 6), 'byg:striped_cypress_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('byg:ebony_planks', 6), 'byg:ebony_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('byg:ebony_planks', 6), 'byg:striped_ebony_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('byg:ether_planks', 6), 'byg:ether_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('byg:ether_planks', 6), 'byg:striped_ether_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('byg:fir_planks', 6), 'byg:fir_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('byg:fir_planks', 6), 'byg:striped_fir_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('byg:green_enchanted_planks', 6), 'byg:green_enchanted_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('byg:green_enchanted_planks', 6), 'byg:striped_green_enchanted_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('byg:holly_planks', 6), 'byg:holly_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('byg:holly_planks', 6), 'byg:striped_holly_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('byg:jacaranda_planks', 6), 'byg:jacaranda_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('byg:jacaranda_planks', 6), 'byg:striped_jacaranda_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('byg:lament_planks', 6), 'byg:lament_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('byg:lament_planks', 6), 'byg:striped_lament_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('byg:mahogany_planks', 6), 'byg:mahogany_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('byg:mahogany_planks', 6), 'byg:striped_mahogany_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('byg:mangrove_planks', 6), 'byg:mangrove_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('byg:mangrove_planks', 6), 'byg:striped_mangrove_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('byg:maple_planks', 6), 'byg:maple_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('byg:maple_planks', 6), 'byg:striped_maple_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('byg:nightshade_planks', 6), 'byg:nightshade_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('byg:nightshade_planks', 6), 'byg:striped_nightshade_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('byg:palm_planks', 6), 'byg:palm_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('byg:palm_planks', 6), 'byg:striped_palm_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('minecraft:birch_planks', 6), 'byg:palo_verde_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('minecraft:birch_planks', 6), 'byg:striped_palo_verde_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('byg:pine_planks', 6), 'byg:pine_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('byg:pine_planks', 6), 'byg:striped_pine_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('byg:rainbow_eucalyptus_planks', 6), 'byg:rainbow_eucalyptus_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('byg:rainbow_eucalyptus_planks', 6), 'byg:striped_rainbow_eucalyptus_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('byg:redwood_planks', 6), 'byg:redwood_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('byg:redwood_planks', 6), 'byg:striped_redwood_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('byg:skyris_planks', 6), 'byg:skyris_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('byg:skyris_planks', 6), 'byg:striped_skyris_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('byg:willow_planks', 6), 'byg:willow_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('byg:willow_planks', 6), 'byg:striped_willow_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('byg:witch_hazel_planks', 6), 'byg:witch_hazel_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('byg:witch_hazel_planks', 6), 'byg:striped_witch_hazel_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('byg:zelkova_planks', 6), 'byg:zelkova_log', Item.of('mekanism:sawdust').withChance(0.25))
    mekSaw(item.of('byg:zelkova_planks', 6), 'byg:striped_zelkova_log', Item.of('mekanism:sawdust').withChance(0.25))
